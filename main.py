import argparse
from dependency_parsers.lit_biaffine_train import biaffine_train
...
def main():
    ...
    parser.add_argument('mode', type=str, choices=['load', 'train'])
    ...
    model.add_argument('--epochs', default=20, help='Number of epochs to train on')
