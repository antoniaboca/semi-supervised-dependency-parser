...
def main():
    ...
    model.add_argument('--oracle', action='store_true', help='Use oracle prior distribution for GE criteria context')
    model.add_argument('--name', type=str, default=None, help='Give name to model for PyTorch Lightning logs')
